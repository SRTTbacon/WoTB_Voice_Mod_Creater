...
<br>
※プログラミング初心者の頃から開発しているもののため、一部コードが複雑かつ、非常に読みにくくなっています。<br>
<br>
...
<br>
# V1.5.7.5<br>
・ソフト内でアップデートが行える機能を追加<br>
・PC版WoTのWwiseの仕様変更に対応<br>
・その他細かなバグを修正<br>
<br>
# V1.5.7<br>
...
・音声Mod作成画面にて、オートセーブ機能を追加<br>
・その他一部仕様を変更、細かなバグを修正<br>
<br>
# V1.5.6<br>
・SEの設定方法を変更 (V1.5.6以前のプリセットは削除されます。)<br>
・音声Modを作成する際の音量を均一にするオプションにて、値を調整しながらテスト再生できるように変更<br>
・複数のサウンドファイルを.wav .mp3 .oggに変換できる機能を追加<br>
・音楽プレイヤーにて、.flacファイルを再生する際、特定の動作でフリーズする問題を修正<br>
・Wwise_Playerで日本語を含む全角文字が入っているファイルを読み込む際、エラーが出る問題を修正<br>
・移動中(?)の音声、SE設定を追加<br>
・一部WoTBのアップデートにより再生されなかったSEを修正<br>
・FSBから変換する際、.bnk形式ではなく.wvs形式に変換するように変更<br>
・その他一部仕様を変更、細かなバグを修正<br>
<br>
# V1.5.5<br>
・WoWSからWoTBに移植したプロジェクトをビルドする際、特定の環境でファイルが破損する不具合を修正<br>
・Youtubeからダウンロードする機能を復旧<br>
<br>
# V1.5.4<br>
・BlitzからWoTへ変換する機能にて、処理時間を大幅に改善
・その他一部仕様を変更、細かなバグを修正
<br>
# V1.5.3.7<br>
